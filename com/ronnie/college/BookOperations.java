...
public class BookOperations {
    ...
    public int compareBookObjects(Book book1, Book book2){
    ...
    public void addBook(Book book) {
        for (int i = 0; i < count; i++) {
            ...
            if(this.compareBookObjects(book, this.theBooks[i]) == 0)
            return;
        }
    ...
    public void searchBySno () {
        System.out.println("\t\t\t\tSEARCH BY SERIA: NUMBER\n");
        ...
        if ( flag == 0)
            System.out.println("No Book for seriel No " + sNo + " Found.");
    }
